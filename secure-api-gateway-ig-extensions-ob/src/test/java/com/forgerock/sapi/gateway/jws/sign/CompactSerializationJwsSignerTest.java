...
public class CompactSerializationJwsSignerTest {
    ...
    private void validateSignedJwt(SignedJWT signedJwt) throws ParseException {
        ...
        assertEquals("https://examplebank.com/api/open-banking/v3.0/pisp/domestic-payments/pmt-7290-003",
                        ...
                        "urn:uk:org:openbanking:events:resource-update", Map.of(
                                "subject", Map.of(
                                        ...
                                        "http://openbanking.org.uk/rlk", Map.of("version", "v3.0",
                                                                                "link",
                                                                                "https://examplebank"
                                                                                        + ".com/api/open-banking/v3"
                                                                                        + ".0/pisp/domestic-payments"
                                                                                        + "/pmt-7290-003"
                                                                               )
                                                 )
                                                                               )
    ...
    public class HeapletTests {
        ...
        void successfullyCreated() throws Exception {
            ...
            // When
            final CompactSerializationJwsSigner jwsSigner =
                    (CompactSerializationJwsSigner) new CompactSerializationJwsSigner.Heaplet().create(
                            defaultSigner,
                            configuration
                            , heap);
            // Then
