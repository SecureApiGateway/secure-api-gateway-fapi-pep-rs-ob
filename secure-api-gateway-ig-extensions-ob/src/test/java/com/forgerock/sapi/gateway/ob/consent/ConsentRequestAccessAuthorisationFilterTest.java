...
import static com.forgerock.sapi.gateway.ob.util.TestHandlers.*;
...
import com.forgerock.sapi.gateway.ob.util.TestHandlers;
...
class ConsentRequestAccessAuthorisationFilterTest {
     ...
     */
    static class CapturingExceptionHandler implements ConsentRequestAccessAuthorisationFilter.ExceptionHandler {
        private final ConsentRequestAccessAuthorisationFilter.ExceptionHandler delegateExceptionHandler = ConsentRequestAccessAuthorisationFilter.createDefaultExceptionHandler();
    ...
    void testFilterCreatedByHeaplet() throws Exception {
        final ConsentRequestAccessAuthorisationFilter.Heaplet heaplet = new ConsentRequestAccessAuthorisationFilter.Heaplet();
